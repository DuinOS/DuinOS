/*
	...
	Ported to AT90USB by Opendous Inc. - 2009-08-30
...
#define portPRESCALE							( (unsigned portCHAR)((1 << CS10) | (1 << CS11)) )
...
//	TCCR1B = portCLEAR_COUNTER_ON_MATCH | portPRESCALE;
